...
**Volume:** 2  
**Pages:** 3 pages  
**Identifier:** jstor-101225  
**JSTOR URL:** <https://www.jstor.org/stable/101225>  
...
being red-hot, I applied the North-pole to another Lath-nail cold, and untoucht before, which it took up but faintly, yet held it suspend-ed for some time,

3. Two or three daies after, I took the same Loadstone, and found that it attracted then as strongly, as before it was cast into the Fire. Whence I inferr'd, that the Fire somewhat lessen'd its Attractive fa-culty, but did not deprive the Stone of it.
