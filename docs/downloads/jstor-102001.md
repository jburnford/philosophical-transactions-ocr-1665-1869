...
It may perhaps be useful to give an Example of the Computation of this Rule, which may seem difficult to some. Let the Solstitial Heat, in $S$ and $W$ be required at London, Lat. $51^\circ 3'2$.

| Co - Lat. | Diff. Actn. |
|-----------|------------|
| $38^\circ - 2'8$ | $33^\circ - 1'1$. |
| $23 - 30$ Decl. | Arc.Semidi.asiv. $123 - 11$. |
| $61 - 58$ Sinus = $882674$ | Arc.Semidinr. hyb.$56 - 49$. Sin.$638923$. |
| $14 - 58$ Sinus = $258257$ | Arc.asiv.mensura $2149955$. |
| Summa $1,140931$ | Arc. hyber mensura $991683$. |
| Diff. $624417$ |
...
So that $2,29734$ will be as the Tropical Summers days Heat, and $0,33895$ as the Action of the Sun in the Day of the Winter Solstice.
After this manner I computed the following Table for every tenth Degree of Latitude, to the Equinoctial and Tropical Sun, by which an Estimate may be made of the intermediate Degrees.

| Lat. | Sun in γ = | Sun in Θ = | Sun in ψ = |
|------|------------|------------|------------|
| 0    | 20000      | 18341      | 18341      |
