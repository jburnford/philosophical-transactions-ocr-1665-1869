# A New Method of Computing the Sums of Certain Series; By Mr. John Landen: Communicated by Mr. Thomas Simpson, F. R. S.

**Author(s):** Thomas Simpson, John Landen  
**Year:** 1759  
**Journal:** Philosophical Transactions (1683-1775)  
**Volume:** 51  
**Pages:** 14 pages  
**Identifier:** jstor-105400  
**JSTOR URL:** <https://www.jstor.org/stable/105400>  
...
Hence, by taking \( x \) equal to \(-1\), we find \(-2 \dot{S} = b^2 + 2 + 2 \dot{S}; \) and, consequently, \( \dot{S} = \frac{a^2}{4} - \frac{1}{2}. \)

And, by taking \( x \) equal to \( \frac{1}{\sqrt{-1}} \), we find

\[ -\frac{2}{\sqrt{-1}} \times \frac{1}{1^2 \cdot 3^2} - \frac{1}{3^2 \cdot 5^2} + \frac{1}{5^2 \cdot 7^2}, \ldots = -2 \dot{Q} - \frac{b^2}{2} + \frac{b}{2} - \frac{1}{\sqrt{-1}} + 1 + 2 \dot{S} = \frac{a}{2 \sqrt{-1}} - \frac{1}{\sqrt{-1}}; \]

and, consequently, \( \frac{1}{1^2 \cdot 3^2} - \frac{1}{3^2 \cdot 5^2} + \frac{1}{5^2 \cdot 7^2}, \ldots = \frac{1}{4} - \frac{a}{4}. \)

Seeing that \( \dot{Q} \) is \( \frac{a^2}{2} \), and \( \dot{S} = \frac{a^2}{4} - \frac{1}{2} \), it follows, from the last article, that

\[ \dot{H} \text{ is } x^2 \dot{Q} + \frac{b x^2 X}{2} - \frac{b X^2}{4} + \frac{b}{4} - x + \frac{x^{-1}}{1 \cdot 3^2} + \frac{x^{-3}}{3 \cdot 5^2} + \frac{x^{-5}}{5 \cdot 7^2}, \ldots \]

From whence, by multiplying by \( \frac{\dot{H}}{x} \), and taking the correct fluent, we get \( \dot{H} \).
\[ H = \frac{x^2 Q}{2} + \frac{b x^2 X}{4} - \frac{b x^2}{4} + \frac{b X}{4} - x + \frac{a^2}{4} \]
\[ - \frac{x^{-1}}{1^2 \cdot 3^2} - \frac{x^{-3}}{3^2 \cdot 5^2} - \frac{x^{-5}}{5^2 \cdot 7^2}, \text{ &c.} \]

And hence, by multiplying by \( x \) \( x \), and taking the correct fluents, we have

\[ H = \frac{x^4 Q}{8} + \frac{b x^4 X}{16} - \frac{5 b x^4}{64} + \frac{b x^2}{16} + \frac{b x^2 X}{8} + \frac{b}{64} \]
\[ - \frac{x^3}{3} - \frac{x}{9} + \frac{4}{9} + \frac{a^2 x^2}{8} - \frac{3 a^2}{16} + 4 S + \frac{x^{-1}}{1 \cdot 3^2 \cdot 5^2} \]
\[ + \frac{x^{-3}}{3 \cdot 5^2 \cdot 7^2} + \frac{x^{-5}}{5 \cdot 7^2 \cdot 9^2}, \text{ &c.} \]

\( S \) being put for the series

\[ \frac{1}{1^2 \cdot 3^2 \cdot 5^2} + \frac{1}{3^2 \cdot 5^2 \cdot 7^2} + \frac{1}{5^2 \cdot 7^2 \cdot 9^2}, \text{ &c.} \]

Now, this value of \( H \) being equal to the value of \( H \) in art. 15. when both series converge, it follows, that

\[ \frac{5 x^5 - x^{-1}}{1^2 \cdot 3^2 \cdot 5^2} + \frac{7 x^7 - 3 x^{-3}}{3^2 \cdot 5^2 \cdot 7^2} + \frac{9 x^9 - 5 x^{-5}}{5^2 \cdot 7^2 \cdot 9^2}, \text{ &c.} \]

is then

\[ = \frac{x^4 Q}{8} + \frac{b x^4 X}{16} - \frac{5 b x^4}{64} + \frac{b x^2}{16} + \frac{b x^2 X}{8} + \frac{b}{64} - \frac{x^3}{3} \]
\[ - \frac{x}{9} + \frac{4}{9} + \frac{a^2 x^2}{8} + \frac{3 a^2}{16} - 4 S. \]

Hence, by taking \( x \) equal to \(-1\), we find \(-4 S\)

\[ = \frac{3 b^2}{8} + \frac{8}{9} + 4 S; \text{ and, consequently, } S = \frac{3 a^2}{64} - \frac{1}{9}. \]
